...
<head>
    ...
    <meta name="description" content="NASR ESPORTS -  Application Form">
    <meta name="author" content="PrOzEx">
    <title>Join NASR</title>
...
<?php
	...
	$to = "Nasresports@Gmail.com";/* YOUR EMAIL HERE */
	$subject = "Join application from Prozex very good robot";
	$headers = "From: Join application Prozex very good robot <noreply@yourdomain.com>";
	...
	while (file_exists( 'upload_files/'.$FinalFilename )) // The folder where the files will be stored; set the permission folder to  0755. 
		...
		if(empty($errors)==true){
			...
			$message .= "\nResume: https://focused-fermi-ae5fb8.netlify.app/upload_files/".$FinalFilename; // Write here the path of your upload_files folder
		}else{
		...
		$userheaders = "From: Join application from NASR <noreply@yourdomain.com>";
